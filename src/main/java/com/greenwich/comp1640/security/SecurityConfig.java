...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                ...
                .antMatchers("/api/faculty/**").hasAnyRole("MARKETING_MANAGER", "MARKETING_COORDINATOR","STUDENT", "GUEST")
                .antMatchers("/api/article/**").hasAnyRole("MARKETING_MANAGER", "MARKETING_COORDINATOR","STUDENT", "GUEST")
                .antMatchers("/api/comment/**").hasAnyRole("MARKETING_MANAGER", "MARKETING_COORDINATOR","STUDENT", "GUEST")
